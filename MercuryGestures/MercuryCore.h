...
static std::map<std::string, int> videosInfo = {
            ...
            {"headLookLeft0.mp4", 190},
            {"headLookLeft1.mp4", 195},
            {"headLookLeft2.mp4", 145},
            {"headLookLeft3.mp4", 160},
            {"headLookLeft4.mp4", 165},
            {"headLookLeft5.mp4", 155},
            {"headLookLeft6.mp4", 150},
            {"headLookLeft7.mp4", 140},
            {"headLookLeft8.mp4", 170},
            {"headLookLeft9.mp4", 145},

            {"headLookRight0.mp4", 110},
            {"headLookRight1.mp4", 140},
            {"headLookRight2.mp4", 135},
            {"headLookRight3.mp4", 120},
            {"headLookRight4.mp4", 130},
            {"headLookRight5.mp4", 135},
            {"headLookRight6.mp4", 130},
            {"headLookRight7.mp4", 155},
            {"headLookRight8.mp4", 155},
            {"headLookRight9.mp4", 155},
            ...
            {"headLookDown0.mp4", 180},
            {"headLookDown1.mp4", 175},
            {"headLookDown2.mp4", 205},
            {"headLookDown3.mp4", 190},
            {"headLookDown4.mp4", 220},
            {"headLookDown5.mp4", 235},
            {"headLookDown6.mp4", 260},
            {"headLookDown7.mp4", 280},
            {"headLookDown8.mp4", 270},
            {"headLookDown9.mp4", 285}
        };
